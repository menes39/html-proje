...
class GenNumber extends React.Component {
  ...
  render() {
    return (
      ...
      React.createElement("p", { className: "app__level" }, "Seviye: ", this.props.level.main, " - ", this.props.level.sub), 
      React.createElement("p", { className: "app__wrong" }, "Hata: ", this.props.wrong, "/3")), 
      React.createElement("p", { className: "app__divider" }, "############################"), 
      React.createElement("p", { className: "app__number", id: "number" }, this.props.wrong < 3 ? atob(this.props.question) : 'Bittiiii'), 
      React.createElement("p", { className: "app__divider" }, "############################")));
...
class InputNumber extends React.Component {
  ...
  render() {
    ...
    if (this.props.wrong < 3) {
      ...
      React.createElement("form", { onSubmit: this.handleUserInput }, "Sayı Benceeeee:", 
      ...
      React.createElement("div", { class: "app__notify" }, "Birdahaki sefere (\u2727\u03C9\u2727)"), React.createElement("br", null), React.createElement("br", null), React.createElement("button", { onClick: this.handleReset }, "Restart"));
